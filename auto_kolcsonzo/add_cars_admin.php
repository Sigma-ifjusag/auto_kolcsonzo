...
<div class="car-box">
    ...
    ?>
        <img src="<?= htmlspecialchars($img['kep']) ?>" class="admin-car-img">
    <?php endwhile; ?>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group"><label>Típus</label>
                    <select name="tipus"><?php foreach(['szemelygepauto','haszonauto','munkagep','motorkerekpar','egyeb'] as $t): ?>
                        <option value="<?= $t ?>" <?= $car['tipus']==$t?'selected':'' ?>><?= $t ?></option>
                    <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group"><label>Üzemanyag</label>
                    <select name="uzemanyag"><?php foreach(['Benzin','Dízel','Benzingaz','Hybrid','Elektromos'] as $u): ?>
                        <option value="<?= $u ?>" <?= $car['uzemanyag']==$u?'selected':'' ?>><?= $u ?></option>
                    <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group"><label>Kivitel</label>
                    <select name="kivitel"><?php foreach(['Sedan','Hatchback','Kombi','SUV','Terepjáró','Pickup','Coupe','Cabrio','Van','Sport','Motor','Egyéb'] as $k): ?>
                ...
                <div class="form-group"><label>Új képek feltöltése</label><input type="file" name="kepek[]" multiple></div>
            </div>
